...
ADMIN_WEB_PORTAL_PROJECT_FOLDER=$FOLDER/WebServices/AdminWebPortal
SEQUENCER_WEB_SERVICE_PROJECT_FOLDER=$FOLDER/WebServices/SequencerWebService
PROCESSOR_WEB_SERVICE_PROJECT_FOLDER=$FOLDER/WebServices/ProcessorWebService
...
ADMIN_WEB_PORTAL_NAME=AdminWebPortal
SEQUENCER_WEB_SERVICE_NAME=SequencerWebService
PROCESSOR_WEB_SERVICE_NAME=ProcessorWebService
...
ADMIN_WEB_ASSEMBLY_FILE=$ADMIN_WEB_PORTAL_NAME.dll
SEQUENCER_WEB_ASSEMBLY_FILE=$SEQUENCER_WEB_SERVICE_NAME.dll
PROCESSOR_WEB_ASSEMBLY_FILE=$PROCESSOR_WEB_SERVICE_NAME.dll
