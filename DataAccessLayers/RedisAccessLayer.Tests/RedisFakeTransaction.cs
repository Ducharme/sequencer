...
{
    public class RedisTransactionMock : ITransaction
    {
        private readonly List<Task> _queuedCommands = new List<Task>();
        ...
        public Task ExecuteAsync(CommandFlags flags = CommandFlags.None)
        {
            Execute();
        ...
        Task<bool> ITransaction.ExecuteAsync(CommandFlags flags)
        {
            throw new NotImplementedException();
        }
    }
