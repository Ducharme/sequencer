...
{
    public class MyStreamMessageTests
    {
        private readonly MyStreamMessage _sampleMessage;

        public MyStreamMessageTests()
        {
            _sampleMessage = new MyStreamMessage
            {
                Sequence = 1,
                Name = "TestMessage",
                Payload = "TestPayload",
        ...
        {
            string expected = "1;TestMessage;TestPayload;500;1715230115432;1715230115638;1715230116138;1715230116181;1715230116427;1715230116953;Stream123";
        ...
        {
            string expected = "Sequence:1, Name:TestMessage, Payload:TestPayload, Delay:500, CreatedAt:1715230115432, ProcessingAt:1715230115638, ProcessedAt:1715230116138, SequencingAt:1715230116181, SavedAt:1715230116427, SequencedAt:1715230116953, StreamId: Stream123";
        ...
        {
            string expected = "Sequence:1, Name:TestMessage, Payload:TestPayload, Delay:500, CreatedAt:2024/05/08 15:35:15.432, ProcessingAt:2024/05/08 15:35:15.638, ProcessedAt:2024/05/08 15:35:16.138, SequencingAt:2024/05/08 15:35:16.181, SavedAt:2024/05/08 15:35:16.427, SequencedAt:2024/05/08 15:35:16.953, StreamId:Stream123";
        ...
        {
            string expected = "Sequence:1, Name:TestMessage, Payload:TestPayload, Delay:500, CreatedAt:15:35:15.432, ProcessingAt:15:35:15.638, ProcessedAt:15:35:16.138, SequencingAt:15:35:16.181, SavedAt:15:35:16.427, SequencedAt:15:35:16.953, StreamId:Stream123";
        ...
        public void ToJson2_ShouldReturnValidJsonString()
        {
            ...
            var deserializedMessage = JsonSerializer.Deserialize<MyStreamMessage>(result);
            ...
            Assert.Equal(_sampleMessage.StreamId, deserializedMessage.StreamId);
        }
    }
}